...
if 'no' in open('agree.txt').read():# take out the wyatt/

    print color.BOLD + """

Note that wyatt is provided as is, and is a royalty free open-source application.
...
"""
	...
	FILE = open("agree.txt","w")# take out the wyatt/
