...
< \033[1;36mwyatt Installer!!\033[1;36m >
...
if option == "1":
    ...
    install2 = os.system("cp -R wyatt/ /opt/ && cp wyatt.py /opt/wyatt && cp run.sh /opt/wyatt && cp run.sh /usr/bin/wyatt && chmod +x /usr/bin/wyatt")
    ...
    print "\033[1;32m[!] Finished Installing! Run 'watt' to run program [!]\033[0m"
